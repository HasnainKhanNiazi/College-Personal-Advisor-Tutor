...
namespace SEGP
{
    public partial class PartialTeacher : UserControl
    {
        ...
        String ss = "select Name,FatherName,Qualification,Field,EmailAddress,Contact,Address,NOS,Image from Teachers where Status='P'";
        ...
        private void menuPDFClick(object sender, System.EventArgs e)
        {
            ...
            PdfWriter writer = PdfWriter.GetInstance(doc, new FileStream("Partial-Teachers.pdf", FileMode.Create));
            doc.Open();

            PdfPTable table = new PdfPTable(dataGridView1.Columns.Count);
            PdfPCell cell = new PdfPCell(new Phrase("PartialTeachers", new iTextSharp.text.Font(iTextSharp.text.Font.NORMAL, 12f, iTextSharp.text.Font.NORMAL, iTextSharp.text.BaseColor.BLUE)));
            cell.Colspan = 9;
